    ...
    <svg viewBox="0 0 400 300" className="ticket-art" fill="none" preserveAspectRatio="xMidYMid meet">
      <defs>
        ...
        <filter id="ff-shadow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="8" stdDeviation="10" floodColor="#0B1F17" floodOpacity="0.08" />
        </filter>
      </defs>
      ...
      <g transform="translate(335 148)">
        <rect width="18" height="16" y="2" rx="3" fill="none" stroke="#1A6B42" strokeWidth="1.6" />
        <path d="M0 7h18" stroke="#1A6B42" strokeWidth="1.6" />
        <path d="M5 0v4M13 0v4" stroke="#1A6B42" strokeWidth="1.6" strokeLinecap="round" />
      </g>
      ...
      <rect x="30" y="254" width="340" height="30" rx="15" fill="#1A6B42" filter="url(#ff-shadow)" />
      <text x="192" y="273" fontSize="14" fontWeight="600" fill="white" textAnchor="middle">
        Submit Profile
      </text>
      <path d="M330 264l6 5-6 5" stroke="white" strokeWidth="1.8" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <g filter="url(#ff-shadow)">
        <rect x="255" y="18" width="115" height="30" rx="15" fill="white" stroke="#E8F4EC" strokeWidth="2" />
        <circle cx="273" cy="33" r="5" fill="#1A6B42" />
...
function TicketChat() {
  return (
    <svg viewBox="0 0 400 300" className="ticket-art" fill="none" preserveAspectRatio="xMidYMid meet">
      ...
      <circle cx="72" cy="42" r="3" fill="#1A6B42" />
      ...
      <path d="M336 150H110a12 12 0 0 0-12 12v14a12 12 0 0 0 12 12h226l16 12v-38a12 12 0 0 0-12-12Z" fill="#E8F4EC" filter="url(#cc-shadow)" />
      <text x="330" y="169" fontSize="11.5" fill="#0B1F17" textAnchor="end">
        That&apos;s common and usually
      </text>
      <text x="330" y="184" fontSize="11.5" fill="#0B1F17" textAnchor="end">
        fades within 10–14 days.
      </text>
      <text x="316" y="204" fontSize="9" fill="#5C8A6F" textAnchor="end">
        10:43 AM
      </text>
      <path d="M322 204l3 3 6-6" stroke="#1A6B42" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <circle cx="358" cy="275" r="14" fill="#1A6B42" filter="url(#cc-shadow)" />
    ...
    <svg viewBox="0 0 400 300" className="ticket-art" fill="none" preserveAspectRatio="xMidYMid meet">
      <defs>
        <filter id="tt-shadow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" floodColor="#0B1F17" floodOpacity="0.06" />
        </filter>
      </defs>
      <rect width="400" height="300" rx="20" fill="#ffffff" />
      ...
      <g filter="url(#tt-shadow)">
        <rect x="286" y="18" width="84" height="26" rx="13" fill="#E8F4EC" />
        <text x="328" y="35" fontSize="10.5" fontWeight="700" fill="#1A6B42" textAnchor="middle">
          Day 3 / 30
        </text>
      </g>
      <line x1="47" y1="80" x2="47" y2="256" stroke="#E8E3D4" strokeWidth="2" />
      <line x1="47" y1="80" x2="47" y2="146" stroke="#1A6B42" strokeWidth="2" />
      <circle cx="47" cy="80" r="18" fill="#1A6B42" filter="url(#tt-shadow)" />
      ...
      <rect x="80" y="60" width="290" height="46" rx="12" fill="#FAF9F6" stroke="#E8F4EC" strokeWidth="1.5" />
